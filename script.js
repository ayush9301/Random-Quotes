...
const dbutton = document.getElementById('dice');
...
const randomD = () => {
    dbutton.style.transform = "rotate(160deg)"
  const random = Math.floor(Math.random() * 5 + 1 );
  dbutton.innerHTML = allDice[random];
  h1.innerHTML = allH1[random]
  p.innerHTML = allP[random]

  console.log(random)

  setTimeout(() => {
    dbutton.style.transform = "rotate(0deg)"

  }, 100);
};


dbutton.addEventListener("click", randomD);
